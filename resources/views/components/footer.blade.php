            ...
            <div class="py-8 border-t border-yellow-400/20">
                <div class="flex flex-col md:flex-row justify-between items-center gap-6">
                    ...
                    <div class="flex space-x-4">
                        ...
                        <!-- Instagram -->
                        <a href="https://www.instagram.com/boutique_ba_shop/?igsh=ajJ5YTQzaWRjejZ0#"  target='_blank' class="w-12 h-12 rounded-full bg-gradient-to-r from-yellow-400 to-yellow-500 text-black flex items-center justify-center social-hover glow-effect">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" class="w-6 h-6" viewBox="0 0 24 24">
            ...
            <div class="py-6 border-t border-yellow-400/20 text-center">
                <div class="flex flex-col md:flex-row justify-between items-center gap-4">
                    <p class="text-gray-300">
                        © 2025 <span class="text-yellow-400 font-semibold">B&A shop</span> - Tous droits réservés
                    </p>
