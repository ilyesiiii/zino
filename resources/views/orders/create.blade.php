            ...
            <div class="grid md:grid-cols-2 gap-6">
               ...
               dark:bg-gray-800 dark:text-white bg-white text-gray-800 transition;">
                ...
                <div>
                    ...
                    <input type="text" name="size" id="size" value="" class=" w-full px-4 py-2 rounded-lg border border-yellow-400 dark:border-yellow-600 
               focus:outline-none focus:ring-2 focus:ring-yellow-500
               dark:bg-gray-800 dark:text-white bg-white text-gray-800 transition;" required>
                </div>
...
<script>
    ...
    function updateLivraisonEtTotal() {
        ...
        totalInput.value = (quantite * prix + livraison);
    }
