...
<body class="bg-gray-50 dark:bg-gray-900 text-gray-800 dark:text-gray-100 min-h-screen">
    ...
    <div class="max-w-4xl mx-auto mt-10 p-6 bg-white dark:bg-black rounded-2xl shadow-lg border border-yellow-500">
        ...
        <form action="{{ route('orders.update', $order->id) }}" method="POST" class="grid grid-cols-1 gap-6" enctype="multipart/form-data">
            @csrf
            @method('PUT')
            ...
            <div class="grid md:grid-cols-2 gap-6">
                <div>
                    ...
                    <input type="text" name="nom" id="nom" value='{{ $order->nom }}' required class=" w-full px-4 py-2 rounded-lg border border-yellow-400 dark:border-yellow-600 
               ...
               dark:bg-gray-800 dark:text-white bg-white text-gray-800 transition;">
                ...
                <div>
                    ...
                    <input type="text" name="prenom" id="prenom" value='{{ $order->prenom }}' required class=" w-full px-4 py-2 rounded-lg border border-yellow-400 dark:border-yellow-600 
               focus:outline-none focus:ring-2 focus:ring-yellow-500
               dark:bg-gray-800 dark:text-white bg-white text-gray-800 transition;">
                </div>
            </div>
            ...
            <div>
                ...
                <input type="number" name="phone" id="phone" value='{{ $order->phone }}' required class=" w-full px-4 py-2 rounded-lg border border-yellow-400 dark:border-yellow-600 
               focus:outline-none focus:ring-2 focus:ring-yellow-500
               dark:bg-gray-800 dark:text-white bg-white text-gray-800 transition;">
            </div>
            ...
            <div class="grid md:grid-cols-2 gap-6">
                <div>
                    <label for="wilaya" class="font-semibold">ancienne Wilaya :{{ $order->wilaya }}</label>
               ...
               dark:bg-gray-800 dark:text-white bg-white text-gray-800 transition;">
                ...
                <div>
                    <label for="commune" class="font-semibold">ancienne Commune  :{{ $order->ville }}</label>
               ...
               dark:bg-gray-800 dark:text-white bg-white text-gray-800 transition;">
                   ...
                   <div>
             <label for="methode_livraison" class="font-semibold">ancienne methode de livraison : {{ $order->methode_livraison }}</label>
            ...
            <div>
               ...
               focus:outline-none focus:ring-2 focus:ring-yellow-500
               dark:bg-gray-800 dark:text-white bg-white text-gray-800 transition resize-none">{{ $order->adresse }}</textarea>
            </div>

            <div class="grid md:grid-cols-2 gap-6">
                <div>
                    <label class="font-semibold">Quantité</label>
                    <input type="number" value="{{ $product->pivot->quantite ?? 1 }}" name="quantite" id="quantite" class=" w-full px-4 py-2 rounded-lg border border-yellow-400 dark:border-yellow-600 
               focus:outline-none focus:ring-2 focus:ring-yellow-500
               dark:bg-gray-800 dark:text-white bg-white text-gray-800 transition;">
                </div>
                ...
                <div>
                    ...
                    <input type="text" name="size" id="size" value="{{ $order->size ?? '' }}" class=" w-full px-4 py-2 rounded-lg border border-yellow-400 dark:border-yellow-600 
               focus:outline-none focus:ring-2 focus:ring-yellow-500
               dark:bg-gray-800 dark:text-white bg-white text-gray-800 transition;">
                </div>
            ...
            <div class="grid md:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <input readonly type="number" name="livraison" id="livraison" value="" class=" w-full px-4 py-2 rounded-lg border border-yellow-400 dark:border-yellow-600 
               focus:outline-none focus:ring-2 focus:ring-yellow-500
               dark:bg-gray-800 dark:text-white bg-white text-gray-800 transition bg-gray-100 dark:bg-gray-800">
                </div>
